...
extern "C"{
    ...
    jintArray Java_com_example_pitchdetection_services_ChordRecognitionService_chordDetection(JNIEnv *env, jclass clazz, jdoubleArray samples, jdoubleArray spectrum_samples) {
    ...
    jdoubleArray Java_com_example_pitchdetection_services_ChordRecognitionService_getChromagram(JNIEnv *env, jclass clazz) {
        jdoubleArray output = env->NewDoubleArray(12);
        env->SetDoubleArrayRegion(output,0,12,cd->getChromagram());
        return output;
    }

    jdoubleArray Java_com_example_pitchdetection_services_ChordRecognitionService_window(JNIEnv *env, jclass clazz, jdoubleArray samples) {
    ...
    jdoubleArray Java_com_example_pitchdetection_services_ChordRecognitionService_fft(JNIEnv *env, jclass clazz, jdoubleArray inputReal, jboolean DIRECT) {
    ...
    jdoubleArray Java_com_example_pitchdetection_services_ChordRecognitionService_bandPassFilter(JNIEnv *env, jclass clazz,
